...
Questions: 
- What kind of conclusions/decisions do you want to make with this groups?
  - Do you want to predict something? is there a special variable that we want to optimize?
  - Do you want to just group these users or are you looking for rules to group future users? 
  - 