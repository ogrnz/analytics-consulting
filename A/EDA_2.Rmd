...
ggplot(data = clothing_type_count, 
  ...
  scale_fill_viridis_b(direction=-1, option="cividis") +
  xlab("Clothing type") +
  geom_text(aes(x=Clothing_Type, y=Percentage, label=paste(Percentage, "%")),
  ...
  labs(fill = "Percentage of students (in %)") + ylab("Percentage of students") +
  ggtitle("Distribution of Clothing Type amongst all students") +
...
ggplot(gender_intr, aes(fill=Type_Interaction, y=Percentage, x=Gender)) + 
    geom_bar(stat="identity") + geom_text(aes(x=Gender, y=Percentage, label=paste(Percentage, "%")), suze=3, position = position_stack(vjust=0.5)) + theme(panel.background = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour="black")) + labs(fill = "Type of Interaction") + ylab("Percentage of students (in %)")+ ggtitle("Type of interactions by Gender") + theme(plot.title = element_text(hjust = 0.5, face="bold.italic", size=14))
```
...
ggplot(clothing_intr, aes(fill=Type_Interaction, y=Percentage, x=Clothing_Type)) + 
    geom_bar(stat="identity") + geom_text(aes(x=Clothing_Type, y=Percentage, label=paste(Percentage, "%")), suze=3, position = position_stack(vjust=0.5)) + theme(panel.background = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour="black")) + labs(fill = "Type of Interaction") + ylab("Percentage of students (in %)")+ ggtitle("Type of interactions by Clothing Type") + theme(plot.title = element_text(hjust = 0.5, face="bold.italic", size=14))
```
...
ggplot(count_intr, aes(fill=Type_Interaction, y=Percentage, x=as.factor(Count))) + 
    geom_bar(stat="identity") + geom_text_repel(aes(x=as.factor(Count), y=Percentage, label=paste(Percentage, "%")), size=2, position = position_stack(vjust=0.5)) + theme(panel.background = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour="black")) + labs(fill = "Type of Interaction") + ylab("Percentage of students (in %)")+ ggtitle("Type of interactions by Number of interactions with each student") + theme(plot.title = element_text(hjust = 0.5, face="bold.italic", size=14)) + coord_flip() + xlab("Number of interactions with a student")
```
